...
import com.debugdrawer.utils.NetworkLog
...
private class NetworkLogAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: android.view.ViewGroup): View {
        ...
        view.findViewById<TextView>(R.id.tv_status).text = when (log.type) {
            com.debugdrawer.utils.NetworkLogType.REQUEST -> "→"
            com.debugdrawer.utils.NetworkLogType.RESPONSE -> "← ${log.responseCode}"
            com.debugdrawer.utils.NetworkLogType.ERROR -> "✗ ${log.responseMessage}"
        }
